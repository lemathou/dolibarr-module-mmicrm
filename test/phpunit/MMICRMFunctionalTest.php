...
/**
 * \file    test/phpunit/MMICRMFunctionalTest.php
 * \ingroup mmicrm
 ...
 * @package Testmmicrm
 */
class MMICRMFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mmicrm/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmicrm/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmicrm/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmicrm/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmicrmwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMICRM_MMICRMTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMICRM_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
